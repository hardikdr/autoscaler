...
replace (
	...
	k8s.io/api => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/api
	k8s.io/apiextensions-apiserver => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/apiextensions-apiserver
	k8s.io/apimachinery => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/apimachinery
	k8s.io/apiserver => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/apiserver
	k8s.io/cli-runtime => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/cli-runtime
	k8s.io/client-go => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/client-go
	k8s.io/cloud-provider => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/cloud-provider
	k8s.io/cluster-bootstrap => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/cluster-bootstrap
	k8s.io/code-generator => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/code-generator
	k8s.io/component-base => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/component-base
	k8s.io/controller-manager => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/controller-manager
	k8s.io/cri-api => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/cri-api
	k8s.io/csi-translation-lib => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/csi-translation-lib
	k8s.io/gengo => k8s.io/gengo v0.0.0-20200428234225-8167cfdcfc14
	k8s.io/heapster => k8s.io/heapster v1.2.0-beta.1
	k8s.io/klog/v2 => k8s.io/klog/v2 v2.2.0
	k8s.io/kube-aggregator => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/kube-aggregator
	k8s.io/kube-controller-manager => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/kube-controller-manager
	k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20200805222855-6aeccd4b50c6
	k8s.io/kube-proxy => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/kube-proxy
	k8s.io/kube-scheduler => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/kube-scheduler
	k8s.io/kubectl => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/kubectl
	k8s.io/kubelet => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/kubelet
	k8s.io/legacy-cloud-providers => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/legacy-cloud-providers
	k8s.io/metrics => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/metrics
	k8s.io/mount-utils => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/mount-utils
	k8s.io/sample-apiserver => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/sample-apiserver
	k8s.io/sample-cli-plugin => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/sample-cli-plugin
	k8s.io/sample-controller => /tmp/ca-update-vendor.az69/kubernetes/staging/src/k8s.io/sample-controller
...
replace k8s.io/kubernetes => /tmp/ca-update-vendor.az69/kubernetes
